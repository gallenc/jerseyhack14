...
public class SimpleInstanceListEditor extends InstanceListEditor  {
	...
	@AutoGenerated
	private HorizontalLayout deleteConfirmHorizontalLayout;
	...
	public SimpleInstanceListEditor() {
		...
		karafListSelect.addValueChangeListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				deleteConfirmHorizontalLayout.setVisible(false);
		...
		askDeleteButton.addClickListener(new ClickListener() {
			private static final long serialVersionUID = 1L;
			public void buttonClick(ClickEvent event) {
				deleteConfirmHorizontalLayout.setVisible(true);
			}
		});
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		// deleteConfirmHorizontalLayout
		deleteConfirmHorizontalLayout = buildDeleteConfirmHorizontalLayout();
		verticalLayout_2.addComponent(deleteConfirmHorizontalLayout);
		
		return verticalLayout_2;
	}

	@AutoGenerated
	private HorizontalLayout buildDeleteConfirmHorizontalLayout() {
		// common part: create layout
		deleteConfirmHorizontalLayout = new HorizontalLayout();
		deleteConfirmHorizontalLayout.setCaption("Are You Sure?");
		deleteConfirmHorizontalLayout.setImmediate(false);
		deleteConfirmHorizontalLayout.setWidth("-1px");
		deleteConfirmHorizontalLayout.setHeight("-1px");
		deleteConfirmHorizontalLayout.setMargin(false);
		...
		deleteConfirmHorizontalLayout.addComponent(deleteNoButton);
		...
		deleteConfirmHorizontalLayout
				.addComponent(deleteKarafInstanceManifestButton);
		
		return deleteConfirmHorizontalLayout;
	}
