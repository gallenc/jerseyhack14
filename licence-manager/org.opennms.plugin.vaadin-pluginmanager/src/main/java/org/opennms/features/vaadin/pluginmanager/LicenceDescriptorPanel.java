...
public class LicenceDescriptorPanel extends CustomComponent {
	...
	public synchronized void setLicenceStr(String licenceStr){
		licenceTextArea.setValue( (licenceStr==null )?  "":licenceStr);
	}

	public synchronized void setLicenceMetadata(LicenceMetadata licenceMetadata){
		...
		if (licenceMetadata.getOptions()==null || licenceMetadata.getOptions().isEmpty()){
			...
			Label l = new Label("No Licence Options Deined");
	...
	private VerticalLayout buildMainLayout() {
		...
		licenceTextArea.setWidth("-1px");
		licenceTextArea.setHeight("-1px");
	...
	private VerticalLayout buildLicenceMetadataVerticalLayout() {
		...
		licensorTextField.setWidth("-1px");
		...
		licenseeTextField.setWidth("-1px");
		...
		durationTextField.setWidth("-1px");
		...
		expiryDateTextField.setWidth("-1px");
		...
		startDateTextField.setWidth("-1px");
		...
		systemIdTextField.setWidth("-1px");
