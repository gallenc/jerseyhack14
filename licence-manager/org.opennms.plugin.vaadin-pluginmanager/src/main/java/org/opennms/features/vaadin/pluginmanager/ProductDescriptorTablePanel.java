		...
		productListSelect.addListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (productListSelect.getValue()!=null) {
					String selectedProductId = productListSelect.getValue().toString();
					ProductDescriptorPanel selectedProductDescriptorPanel = panelIds.get(selectedProductId);
					if (selectedProductDescriptorPanel!=null) selectedProductDescriptorPanel.setVisible(true);
				}
