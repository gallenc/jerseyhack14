...
public class PluginModel {
	...
	String systemId = "abcd";

	String pluginServerPassword = "admin";

	String pluginServerUsername = "admin";

	String pluginServerUrl = "http://localhost:8980";
	...
	public void generateRandomSystemId(){
