...
public class PluginManagerUIMainPanel extends CustomComponent {
	...
	@AutoGenerated
	private TextField availableFeatureName;
	...
	public PluginManagerUIMainPanel() {
		...
		// example adding code
		availableFeaturesListSelect_1.addItem("Mercury");
		availableFeaturesListSelect_1.addItem("Venus");
		availableFeaturesListSelect_1.addItem("Earth");
		availableFeaturesListSelect_1.addItem("Mars");
		availableFeaturesListSelect_1.addItem("Jupiter");
		availableFeaturesListSelect_1.addItem("Saturn");
		availableFeaturesListSelect_1.addItem("Neptune");
		availableFeaturesListSelect_1.addItem("Uranus");
        
        // Show 5 items and a scrollbar if there are more
		availableFeaturesListSelect_1.setRows(5);
		
		availableFeatureName.setValue("not selected");
		
        // Feedback on value changes
		availableFeaturesListSelect_1.addListener(new Property.ValueChangeListener() {
            private static final long serialVersionUID = 4777915807221505438L;
            
            @Override
            public void valueChange(ValueChangeEvent event) {
            	availableFeatureName.setValue(availableFeaturesListSelect_1.getValue().toString());
            }
        });
