...
public class PluginManagerUIMainPanel extends CustomComponent {
	...
	public void updateDisplayValues(){
		...
		ProductSpecList pluginsManifestList = sessionPluginModel.getPluginsManifest();
		...
		manifestSystemIdTextField.setValue(sessionPluginModel.getManifestSystemId());
	...
	public PluginManagerUIMainPanel(SessionPluginModel sessionPluginModel) {
		this.sessionPluginModel=sessionPluginModel;
		...
		updateSystemIdButton.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				try{
					...
					sessionPluginModel.setManifestSystemId(newManifestSystemId);
					message = "manifestSystemId for karafInstance "+sessionPluginModel.getKarafInstance()
							+" updated to "+newManifestSystemId;

					sessionPluginModel.setSystemId(newManifestSystemId);
					message = message+"\nsystemId for karafInstance "+sessionPluginModel.getKarafInstance()
							+" updated to "+newManifestSystemId;
					...
					systemMessages.setValue(message +"\nproblem updating systemId for karafInstance "
							+sessionPluginModel.getKarafInstance()+" : "+e.getMessage());
				}
			}
		});
		...
		generateRandomManifestSystemIdButton.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				try{
					String randomManifestSystemId = sessionPluginModel.generateRandomManifestSystemId();
		...
		ProductSpecList pluginsManifestList = sessionPluginModel.getPluginsManifest();
		if (pluginsManifestList!=null) pluginsManifestPanel.addProductList(pluginsManifestList);
		PluginManifestControlsPanel pluginManifestControlsPanel= new PluginManifestControlsPanel();
		pluginManifestControlsPanel.setSessionPluginModel(sessionPluginModel);
