...
public class LicenceDescriptorTablePanel extends CustomComponent {
		...
		licenceListSelect.addValueChangeListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (licenceListSelect.getValue()!=null) {
					String selectedLicenceId = licenceListSelect.getValue().toString();
					LicenceDescriptorPanel selectedLicenceDescriptorPanel = panelIds.get(selectedLicenceId);
					if (selectedLicenceDescriptorPanel!=null) selectedLicenceDescriptorPanel.setVisible(true);
				}
	...
	public synchronized void addLicenceList(LicenceList licencelist){
		...
		for (String productId: lmap.keySet()){
			...
			licenceDescriptorPanel.setLicenceStr(lmap.get(productId).getLicenceStr());
