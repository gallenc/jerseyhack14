...
public class PluginManagerUIMainPanel extends CustomComponent {
	...
	private VerticalLayout buildFeatureSettingsPanel() {
		...
		systemMessagesTextArea.setHeight("-1px");
		featureSettingsPanel.addComponent(systemMessagesTextArea);
		...
		featureSettingsPanel.addComponent(seeFullMessageButton);
		featureSettingsPanel.setComponentAlignment(seeFullMessageButton,
				new Alignment(6));
