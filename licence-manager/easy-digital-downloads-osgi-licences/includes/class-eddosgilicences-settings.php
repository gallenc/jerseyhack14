...
class eddOsgiLicences_Settings {
	...
	public function add_menu_item() {
		$page = add_options_page ( __ ( 'OSGi Plugin Settings', 'eddosgilicences' ), __ ( 'OSGi Plugin Settings', 'eddosgilicences' ), 'manage_options', $this->parent->_token . '_settings', array (
				$this,
				'settings_page' 
		) );
	...
	private function settings_fields() {
		$settings ['standard'] = array (
				...
				'description' => __ ( 'Settings for OSGi Licence Publisher', 'eddosgilicences' ),
				'fields' => array (
						array (
								'id' => 'osgi_username',
	...
	public function settings_page() {
		...
		$html .= '<h2>' . __ ( 'OSGi Plugin Settings', 'eddosgilicences' ) . '</h2>' . "\n";
