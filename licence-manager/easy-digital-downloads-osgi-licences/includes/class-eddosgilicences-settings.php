...
class eddOsgiLicences_Settings {
	...
	public function add_menu_item () {
		$page = add_options_page( __( 'Plugin Settings', 'eddosgilicences' ) , __( 'Plugin Settings', 'eddosgilicences' ) , 'manage_options' , $this->parent->_token . '_settings' ,  array( $this, 'settings_page' ) );
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'eddosgilicences' ) . '</a>';
	...
	private function settings_fields () {
		...
		$settings['standard'] = array(
			'title'					=> __( 'Standard', 'eddosgilicences' ),
			'description'			=> __( 'These are fairly standard form input fields.', 'eddosgilicences' ),
			'fields'				=> array(
				array(
					'id' 			=> 'text_field',
		...
		$settings['extra'] = array(
			...
			'description'			=> __( 'These are some extra input fields that maybe aren\'t as common as the others.', 'eddosgilicences' ),
			'fields'				=> array(
				array(
					'id' 			=> 'number_field',
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Plugin Settings' , 'eddosgilicences' ) . '</h2>' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'eddosgilicences' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main eddOsgiLicences_Settings Instance
	 *
	 * Ensures only one instance of eddOsgiLicences_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see eddOsgiLicences()
	 * @return Main eddOsgiLicences_Settings instance
	 */
