...
confirm the following entry in present
 true    mvn:org.opennms.plugins/org.opennms.plugin.featuremanager.feature/1.0-SNAPSHOT/xml/features

karaf@root> features:listrepositories

confirm the following entry in present
org.opennms.plugin.featuremanager.feature 


2. install feature manager feature

karaf@root> features:install org.opennms.plugin.featuremanager.feature/1.0-SNAPSHOT

3. check that the feature manager and jersey dependencies are installed
karaf@root> list
START LEVEL 100 , List Threshold: 50
   ID   State         Blueprint      Level  Name
[ 273] [Active     ] [Created     ] [   80] org.opennms.plugin.featuremanager (1.0.0.SNAPSHOT)
...
http://localhost:8980/opennms/featuremgr/diagnostics/feature-mgr-rest-diagnostics.html

You can run the tests against a feature manager installed on opennms by 
copying 
/src/main/resources/featuresServiceTestKaraf.properties 
to
/src/main/resources/featuresServiceTest.properties
